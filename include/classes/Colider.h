...
std::vector<std::shared_ptr<Entidade>> check_colison(std::vector<std::shared_ptr<Entidade>> vec_hitboxes,int *pontos);
...
std::vector<std::shared_ptr<Entidade>> handle_colison(std::vector<std::shared_ptr<Entidade>> vec_hitboxes,int *pontos);
